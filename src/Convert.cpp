...
#define HARD_REGNO_CALL_PART_CLOBBERED(REGNO, MODE) 0
    ...
    bool TreeToLLVM::EmitBuiltinVAStart(
#if (GCC_MAJOR > 4)
                                        gimple *stmt
#else
                                        gimple stmt
    ...
    bool TreeToLLVM::EmitBuiltinVAEnd(
#if (GCC_MAJOR > 4)
                                      gimple *stmt
#else
                                      gimple stmt
    ...
    bool TreeToLLVM::EmitBuiltinVACopy(
#if (GCC_MAJOR > 4)
                                       gimple *stmt
#else
                                       gimple stmt
    ...
    bool TreeToLLVM::EmitBuiltinAdjustTrampoline(
#if (GCC_MAJOR > 4)
                                                 gimple *stmt,
#else
                                                 gimple stmt,
    ...
    bool TreeToLLVM::EmitBuiltinInitTrampoline(
#if (GCC_MAJOR > 4)
                                               gimple *stmt,
#else
                                               gimple stmt,
      ...
      if (OnStack) {
        tree target =
#if (GCC_MAJOR > 4)
            TREE_OPERAND(gimple_call_arg(as_a<gcall *>(stmt), 1), 0);
#else
    ...
    void TreeToLLVM::RenderGIMPLE_RESX(
#if (GCC_MAJOR > 4)
                                       gimple *stmt
#else
                                       gimple stmt
...
// Ternary expressions.
    ...
    Value *TreeToLLVM::OutputCallRHS(
#if (GCC_MAJOR > 4)
                                     gimple *stmt,
#else
                                     gimple stmt,
